...
export default class Settings extends React.Component{
    ...
    logout(){
       ...
       axios.post('https://qvsn1ge17c.execute-api.us-east-2.amazonaws.com/latest/api/logout', {
      }, {
        headers: {
    ...
    render(){
        ...
        return (
                ...
                <View style={styles.container}>
                        ...
                        <Text style={styles.aboutInfo}>Boozy is an app to help you find the best happy hour deals in your area.
						</Text>
						<Text style={styles.creatorText}>About Us</Text>
                        <Text style={styles.creatorInfo}>Isaiah Jenkins, Hayden Miller, Chelsea Kaye Punzalan {"\n"} 
