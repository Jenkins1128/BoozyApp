...
import { StyleSheet, Image, Text, TextInput, ScrollView, TouchableOpacity, View, Dimensions, TouchableHighlight, Animated } from 'react-native';
...
export default class Profile extends React.Component {
	...
	render() {
		let restaurants = this.state.restaurantsArray.map((val, key) => {
			return <Favorites key={key} keyval={key} val={val} viewFavorite={() => this.viewFavorites(key)} />;
		});
